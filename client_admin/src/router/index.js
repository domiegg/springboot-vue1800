...
const routes = [
	...
	// 会员中心路由
	{
		path: '/member_center/table',
		name: 'member_center_table',
		component: () => import('../views/member_center/table.vue'),
		meta: {
			index: 0,
			title: '会员中心列表'
		}
	...
	{
		path: '/member_center/view',
		name: 'member_center_view',
		component: () => import('../views/member_center/view.vue'),
		meta: {
			index: 0,
			title: '会员中心详情'
		}
	...
	// 促销管理路由
	{
		path: '/promotion_management/table',
		name: 'promotion_management_table',
		component: () => import('../views/promotion_management/table.vue'),
		meta: {
			index: 0,
			title: '促销管理列表'
		}
	...
	{
		path: '/promotion_management/view',
		name: 'promotion_management_view',
		component: () => import('../views/promotion_management/view.vue'),
		meta: {
			index: 0,
			title: '促销管理详情'
		}
	...
	// 运营管理路由
	{
		path: '/operation_management/table',
		name: 'operation_management_table',
		component: () => import('../views/operation_management/table.vue'),
		meta: {
			index: 0,
			title: '运营管理列表'
		}
	...
	{
		path: '/operation_management/view',
		name: 'operation_management_view',
		component: () => import('../views/operation_management/view.vue'),
		meta: {
			index: 0,
			title: '运营管理详情'
		}
	...
	// 财务管理路由
	{
		path: '/financial_management/table',
		name: 'financial_management_table',
		component: () => import('../views/financial_management/table.vue'),
		meta: {
			index: 0,
			title: '财务管理列表'
		}
	...
	{
		path: '/financial_management/view',
		name: 'financial_management_view',
		component: () => import('../views/financial_management/view.vue'),
		meta: {
			index: 0,
			title: '财务管理详情'
		}
