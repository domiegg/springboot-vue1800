	...
	<el-main class="bg table_wrap">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					...
					<el-form-item label="商品编号">
									<el-input v-model="query.article_no"></el-input>
								</el-form-item>
				</el-col>
									<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="销售类型">
									<el-input v-model="query.sales_type"></el-input>
								</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="cart_description" label="描述" min-width="200">
				...
				<el-table-column prop="article_no" @sort-change="$sortChange" label="商品编号"
				v-if="user_group == '管理员' || $check_field('get','article_no')" min-width="200">
					</el-table-column>
					<el-table-column prop="sales_type" @sort-change="$sortChange" label="销售类型"
				v-if="user_group == '管理员' || $check_field('get','sales_type')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/mall_center/table','set') || $check_action('/mall_center/view','set') || $check_action('/mall_center/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
