		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户账号" prop="user_account">
												<el-input id="user_account" v-model="form_sub['user_account']" placeholder="请输入用户账号"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','user_account')) || (!form_sub['ordinary_users_id'] && $check_field('add','user_account'))"></el-input>
					<div v-else-if="$check_field('get','user_account')">{{form_sub['user_account']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="年龄" prop="age">
						...
						v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','age')) || (!form_sub['ordinary_users_id'] && $check_field('add','age'))"></el-input-number>
