...
const routes = [
		...
		// 商城中心详情路由
	{
		...
		// 帮助中心列表路由
	{
		path: '/help_center/list',
		name: '/help_center_list',
		component: () => import('../views/help_center/list.vue')
	},
	
		// 帮助中心详情路由
	{
		path: '/help_center/details',
		name: '/help_center_details',
		component: () => import('../views/help_center/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "电商平台系统-home";
	document.title = title;
	document.logo = "电商平台系统"
})
