	...
	<div class="diy_home diy_list diy_help_center" id="diy_help_center_list">
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','help_cover')">
						帮助封面
					</th>
							<th class="diy_title" v-if="$check_field('get','help_topics')">
						帮助主题
					</th>
							</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field" v-if="$check_field('get','help_cover')">
						<img class="diy_img" :src="o['help_cover']" />
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','help_topics')">
						<span>
							{{ o["help_topics"] }}
						</span>
					</td>
