<template>
	<div class="diy_home diy_list diy_member_center" id="diy_member_center_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/member_center/details?member_center_id=' + o['member_center_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/member_center/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/member_center/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						年龄
							...
							<th class="diy_title" v-if="$check_field('get','member_id')">
						会员号
					</th>
							<th class="diy_title" v-if="$check_field('get','customer_star_rating')">
						客户星级
					</th>
							</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','member_id')">
						<span>
							{{ o["member_id"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','customer_star_rating')">
						<span>
							{{ o["customer_star_rating"] }}
						</span>
					</td>
							</tr>
			</table>
