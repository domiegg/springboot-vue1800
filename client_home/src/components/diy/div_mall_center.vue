			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/mall_center/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        ...
        var mall_center_id = this.obj.mall_center_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "mall_center",
          source_field: "mall_center_id",
          source_id: mall_center_id
        }, (res) => {
